...
const Login = () => {
    ...
    useEffect(() => {
        ...
        if (session) {
            router.push('/deshboard'); // (Also: might be a typo — "dashboard" instead of "deshboard"?)
        }
    }, [session, router]);
    return (
        <div className='text-white py-14 container mx-auto'>
            ...
            <div className="flex flex-col gap-2 min-h-screen  p-10 items-center ">
                ...
                <button
                    className="flex items-center text-black w-60 bg-slate-50 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
